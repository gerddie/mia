...
int do_main(int argc, char **argv)
{
	...
	options.add(make_opt( src_filename, "in-file", 'i', "input image", CCmdOption::required, &lmxio));
	options.add(make_opt( out_filename, "out-file", 'o', "transformed image", CCmdOption::required, &lmxio));
