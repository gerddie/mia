...
int main(int argc, const char *args[])
{
	...
	options.push_back(make_opt( even_start, "even-start", 'e', "start with centers evenly distributed over the histogram")); 
	options.push_back(make_opt( class_centers, "class-centers", 'c', "initial class centers", "")); 
	options.push_back(make_opt( auto_k, "auto", 'a', "atomatic adaption of variance (experimental)")); 
	options.push_back(make_opt( cut_histo,"cut-histo", 't', "cut empty histogram at the end "));
