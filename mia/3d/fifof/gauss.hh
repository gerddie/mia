...
private:
	...
	void shift_buffer();
	size_t _M_hw;
	mia::C2DFilterPlugin::ProductPtr _M_gauss2d;
	mia::C2DBounds _M_slice_size;
	mia::C1DSpacialKernelPlugin::ProductPtr _M_1dfilter;
	std::auto_ptr<mia::C3DFImage> _M_buffer;
	std::auto_ptr<mia::C3DImage> _M_dummy;
};
