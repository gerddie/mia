...
if (UNIX)
    if (APPLE)
        ...
        # LINUX
        set(_TBB_DEFAULT_INSTALL_DIR "/usr/include" "/opt/intel/tbb" "/usr/local/include" )
        set(_TBB_LIB_NAME "tbb")
        set(_TBB_LIB_MALLOC_NAME "${_TBB_LIB_NAME}malloc")
        set(_TBB_LIB_DEBUG_NAME "${_TBB_LIB_NAME}_debug")
        set(_TBB_LIB_MALLOC_DEBUG_NAME "${_TBB_LIB_MALLOC_NAME}_debug")
...
# sanity check
if (NOT _TBB_INSTALL_DIR)
    message ("WARNING: No preset TBB_INSTALL_DIR not found. ${_TBB_INSTALL_DIR}")
    set(_TBB_INSTALL_DIR "/usr")
